...
#   timestamp: 2025-12-28T20:35:21+00:00
...
class Env(HomelabRootModel[str]):
    root: str = Field(
        ...,
...
class RegistryAuths(HomelabBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ContinueOn(str, Enum):
    skipped = "skipped"
    failed = "failed"


class ContinueOn1(HomelabBaseModel):
    failure: bool | None = Field(
...
class Env2(HomelabRootModel[str]):
...
class Step(HomelabBaseModel):
    ...
    command: str | list[str | float | bool] | None = Field(
        None,
        description="Command to execute. Can be a shell command, script interpreter, or executable.",
    )
    ...
    continue_on: ContinueOn | ContinueOn1 | None = Field(
        None,
        alias="continueOn",
...
class Model(HomelabBaseModel):
    ...
    params: str | list[str | dict[str, Any]] | dict[str, Any] | Params | None = Field(
        None,
    ...
    registry_auths: str | dict[str, str | RegistryAuths] | None = Field(
        None,
        alias="registryAuths",
