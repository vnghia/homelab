...
#   timestamp: 2025-02-16T18:57:54+00:00
...
class Step(HomelabBaseModel):
    ...
    run: str | None = Field(
        None, description="Name of a sub-workflow (another DAG) to run as this step."
    )
    params: str | None = Field(
        None, description="Parameters to pass to the sub-workflow when using 'run'."
    )
...
class Model(HomelabBaseModel):
    ...
    params: str | list[dict[str, Any]] | None = Field(
        None,
