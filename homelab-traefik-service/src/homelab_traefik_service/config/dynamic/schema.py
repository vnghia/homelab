...
class Cookie(BaseModel):
    ...
    http_only: bool | None = Field(False, alias="httpOnly")
...
class CompressMiddleware(BaseModel):
    ...
    included_content_types: list[str] | None = Field(
        None,
        alias="includedContentTypes",
...
class ForwardAuthMiddleware(BaseModel):
    ...
    add_auth_cookies_to_response: list[str] | None = Field(
        None,
        alias="addAuthCookiesToResponse",
...
class IpAllowListMiddleware(BaseModel):
    ...
    reject_status_code: int | None = Field(
        None,
        alias="rejectStatusCode",
